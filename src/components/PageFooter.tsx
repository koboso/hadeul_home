        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 md:gap-8">
          ...
          <div className="md:col-span-4">
            ...
            <nav className="flex flex-wrap gap-x-5 gap-y-2 text-[13px] text-white/50">
              ...
              <Link href="/careers" className="hover:text-white transition-colors">인재채용</Link>
              <Link href="/inquiry" className="hover:text-white transition-colors">문의</Link>
            </nav>
          </div>

          {/* Center — Company Info */}
          <div className="md:col-span-5 text-[12px] text-white/40 leading-[1.9] space-y-0">
            <p className="text-white/60 text-[13px] font-semibold mb-2">주식회사 하들소프트</p>
            <p>대표 : 김재식</p>
          ...
          <div className="md:col-span-3 flex flex-col items-start md:items-end gap-3">
            <a
              href="/my/privacy.php"
              className="text-[12px] text-white/45 hover:text-purple-400 transition-colors"
            >
              개인정보처리방침
            </a>
            <a
